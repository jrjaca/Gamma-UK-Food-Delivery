            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="{{ route('index') }}" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                                                <img src="{{ asset($site_setting->logo_path) }}" alt="logo images" style="width: 80px; height: 50px;">
                                            </span>
                    </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div>
                                            <img src="{{ asset('backend') }}/images/megamenu-img.png" alt="" class="img-fluid mx-auto d-block">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="d-flex">
                ...
                {{--<div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="" src="{{ asset('backend') }}/images/flags/us.jpg" alt="Header Language" height="16">
                    </button>
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        ...
                        <img class="rounded-circle header-profile-user"
                             src="{{ Gravatar::src(Auth::user()->email) }}"style="border-radius: 50%; width: 30px; height: 30px;"
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <!-- item-->
                        <a class="dropdown-item" href="{{ route('home') }}"><i class="bx bx-user font-size-16 align-middle mr-1"></i> Profile</a>
                        {{--<a class="dropdown-item" href="#"><i class="bx bx-wallet font-size-16 align-middle mr-1"></i> My Wallet</a>
                        <a class="dropdown-item d-block" href="#"><span class="badge badge-success float-right">11</span><i class="bx bx-wrench font-size-16 align-middle mr-1"></i> Settings</a>
                        <a class="dropdown-item" href="#"><i class="bx bx-lock-open font-size-16 align-middle mr-1"></i> Lock screen</a>--}}
                        {{--<div class="dropdown-divider"></div>--}}
                        <a class="dropdown-item" href="{{ route('index') }}"><i class="bx bx-wallet font-size-16 align-middle mr-1"></i> Back to Main Page</a>
                        {{--<a class="dropdown-item" href="{{ route('home') }}"><i class="bx bx-wallet font-size-16 align-middle mr-1"></i>  Back to Main Profile Page</a>--}}
                        <div class="dropdown-divider"></div>
                        <!-- START Logout -->
