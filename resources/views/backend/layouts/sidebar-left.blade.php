                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                   ...
                   {{-- <li class="menu-title">PRODUCTS</li>--}}
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ route('admin.meal-type.index') }}">Manage All Meal Types</a></li>
                                <li><a href="{{ route('admin.meal-type.create') }}">Add Meal Type</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ route('admin.food-type.index') }}">Manage All Food Types</a></li>
                                <li><a href="{{ route('admin.food-type.create') }}">Add Food Type</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span>Product (Meal)</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ route('admin.meal.index') }}">Manage All Products</a></li>
                                <li><a href="{{ route('admin.meal.create') }}">Add Product</a></li>
                            </ul>
                        </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="{{ url('admin/payments/status/0') }}">New</a></li>
                            <li><a href="{{ url('admin/payments/status/1') }}">Accepted</a></li>
                            <li><a href="{{ url('admin/payments/status/2') }}">For Delivery</a></li>
                            <li><a href="{{ url('admin/payments/status/3') }}">Delivered</a></li>
                            <li><a href="{{ url('admin/payments/status/4') }}">Cancelled</a></li>
                            <li><a href="{{ url('admin/payments/status/5') }}">Returned</a></li>
                        </ul>
                    </li>
                    ...
                    {{--<li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="{{ url('admin/orders/status/0') }}">New</a></li>
                            <li><a href="{{ url('admin/orders/status/1') }}">Accepted</a></li>
                            <li><a href="{{ url('admin/orders/status/2') }}">For Delivery</a></li>
                            <li><a href="{{ url('admin/orders/status/3') }}">Delivered</a></li>
                            <li><a href="{{ url('admin/orders/status/4') }}">Cancelled</a></li>
                            <li><a href="{{ url('admin/orders/status/5') }}">Returned</a></li>
                        </ul>
                    </li>--}}
                    ...
                    {{--<li class="menu-title">USER</li>--}}
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ route('admin.users') }}">List of Users</a></li>
                                <li><a href="{{ route('admin.user.messages') }}">Message
                                        {{--<span class="badge badge-pill badge-info float-right">03</span>--}}</a></li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('admin.site-setting.details.edit') }}">Details</a></li>
                            <li><a href="{{ route('admin.site-setting.images.edit') }}">Images</a></li>
                        </ul>
                    </li>
