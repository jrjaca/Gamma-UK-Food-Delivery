            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin.home') }}">Refresh</a></li>
                    </ol>
                </div>
                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="text-primary p-3">
                                <h5 class="text-primary">Admin Page</h5>
                                {{--<p>Skote Dashboard</p>--}}
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    <p class="text-muted font-weight-medium">Paypal Transaction</p>
                                    <h4 class="mb-0">{{ number_format($data['paypal_transaction'],0, '.', ',') }}</h4>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    <p class="text-muted font-weight-medium">Paypal Amount</p>
                                    <h4 class="mb-0">£ {{ number_format($data['paypal_amount'],2, '.', ',') }}</h4>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    ...
                                    <h4 class="mb-0">{{ number_format($data['orders'],0, '.', ',') }}</h4>
                                </div>
                                <div class="avatar-sm rounded-circle bg-primary align-self-center mini-stat-icon">
                                                                <span class="avatar-title rounded-circle bg-primary">
                                                                    <i class="bx bx-archive-in font-size-24"></i>
                ...
                <div class="col-md-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    <p class="text-muted font-weight-medium">Stripe Transaction</p>
                                    <h4 class="mb-0">{{ number_format($data['stripe_transaction'],0, '.', ',') }}</h4>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    <p class="text-muted font-weight-medium">Stripe Amount</p>
                                    <h4 class="mb-0">£ {{ number_format($data['stripe_amount'],2, '.', ',') }}</h4>
                                </div>
