...
@section('title', 'Update Product (Meal)')
        ...
        <div class="col-12">
            <div class="card">
                ...
                <!-- END Display Error Message-->
                    ...
                    <form class="needs-validation outer-repeater" action="{{ route('admin.meal.update') }}" method="post" enctype="multipart/form-data" novalidate>
                        @csrf
                        <input type="hidden" readonly value="{{ $meal->id }}" id="mid" name="mid"/>
                        <h4 class="card-title mb-4">Add New</h4>
                        <div data-repeater-list="outer-group" class="outer">
                            <div data-repeater-item class="outer">
                                <input type="hidden" readonly value="{{ $meal->id }}" id="mealid" name="mealid"/>
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        <label for="name">Name<span style="color: red;">*</span> :</label>
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $meal->name }}" autocomplete="name" placeholder="Enter a name..." autofocus required>
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <select class="form-control select2-search-disable" name="food_type_id"
                                            ...
                                            @foreach($food_types as $row)
                                                <option value="{{ $row->id }}" {{ $meal->food_type_id == $row->id ? 'selected' : '' }}>{{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <div style="display: none;">
                                            <select class="select2 form-control select2-multiple" multiple="multiple" name="meal_type_id_old"
                                                    data-placeholder="Choose..." required style="width: 100%">
                                                <option value=""></option>
                                                @foreach($meal_types as $row)
                                                        <option value="{{ $row->id }}" {{ in_array($row->id, $meal_mealtypes) ? " selected " : ""}}>
                                                            {{ $row->name }}
                                                        </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <textarea class="form-control" id="description" name="description" autocomplete="description" required>{!! $meal->description !!}</textarea>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input id="regular_price" class="form-control input-mask text-left" name="regular_price" placeholder="0.00" maxlength="9" value="{{ $meal->regular_price }}"
                                               data-inputmask="'alias': 'numeric', 'placeholder': '0.00'" required>
                                        {{--'prefix': '$ ',--}}   {{--'groupSeparator': ',', 'digits': 2, 'digitsOptional': false,--}}
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input id="discounted_price" class="form-control input-mask text-left" name="discounted_price" placeholder="0.00" maxlength="9" value="{{ $meal->discounted_price }}"
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input id="delivery_cost" class="form-control input-mask text-left" name="delivery_cost" placeholder="0.00" maxlength="9" value="{{ $meal->delivery_cost }}"
                                               data-inputmask="'alias': 'numeric', 'placeholder': '0.00'">
                                        <div class="invalid-feedback">
                                            Delivery Cost.
                                        </div>
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input id="delivery_time" class="form-control input-mask text-left" name="delivery_time" placeholder="000" maxlength="4" value="{{ $meal->delivery_time }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="checkbox" id="tag_new" name="tag_new" switch="warning" {{ $meal->tag_new == 1 ? 'checked' : '' }}/>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="checkbox" id="tag_hot" name="tag_hot" switch="warning" {{ $meal->tag_hot == 1 ? 'checked' : '' }}/>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="checkbox" id="tag_special_offer" name="tag_special_offer" switch="warning" {{ $meal->tag_special_offer == 1 ? 'checked' : '' }}/>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="checkbox" id="tag_popular_menu" name="tag_popular_menu" switch="warning" {{ $meal->tag_popular_menu == 1 ? 'checked' : '' }}/>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="checkbox" id="tag_our_gallery_footer" name="tag_our_gallery_footer" switch="warning" {{ $meal->tag_our_gallery_footer == 1 ? 'checked' : '' }}/>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="checkbox" id="tag_latest_menu_footer" name="tag_latest_menu_footer" switch="warning" {{ $meal->tag_latest_menu_footer == 1 ? 'checked' : '' }}/>
                                ...
                                <div class="inner-repeater mb-4" >
                                    <div data-repeater-list="inner-group" class="inner form-group">
                                        ...
                                        <div class="form-group col-lg-12" style="text-align: center">
                                            <label for="images_path">Add, Update Image/s Here</label>
                                        </div>
                                            {{--{{ dd($allmealimagesbymealid) }}--}}

                                            {{--default/initial for add. image_id value="0"--}}
                                            <div style="display: none;">
                                                <div data-repeater-item class="inner mb-3 row">
                                                    ...
                                                    <input type="hidden" name="outer-group[0][inner-group][0][image_id]" value="0" readonly>
                                                    <div class="form-group col-lg-3">
                                                        {{--<input type="text" class="form-control" name="name_image" autocomplete="name_image" placeholder="Enter a image name...">--}}
                                                        <input type="text" class="form-control" name="outer-group[0][inner-group][0][name_image]" autocomplete="name_image" placeholder="Enter a image name...">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-lg-3">
                                                        ...
                                                        <input type="text" class="form-control" name="outer-group[0][inner-group][0][name_description]" autocomplete="name_description" placeholder="Enter image description...">
                                                    </div>

                                                    <div class="form-group col-lg-3">
                                                        <div class="custom-file">
                                                            {{--<input type="file" class="custom-file-input" id="customFile" name="images_path" required onchange="readUrlImage(this);">--}}
                                                            <input type="file" class="custom-file-input" id="customFile" name="outer-group[0][inner-group][0][images_path]" value="" onchange="readUrlImage(this);">
                                                            {{--<label class="custom-file-label" for="customFile" name="image_path_label">Choose Image</label>--}}
                                                            <label class="custom-file-label" for="customFile" name="outer-group[0][inner-group][0][image_path_label]">Attach Image</label>
                                                            {{--<div class="invalid-feedback">
                                                    ...
                                                    <div class="form-group col-lg-1" style="text-align: center">
                                                        {{--<img src="{{asset($row->path)}}" style="width: 65px; height: 50px;" --}}{{-- id="image_prev" name="image_prev" >--}}{{--style="position: absolute; top: 20%; left: 0%;"--}}
                                                        <img src="" id="image_prev" name="outer-group[0][inner-group]0][image_prev]">
                                                        {{--<img src="" id="image_prev" name="image_prev">--}}
                                                    </div>
                                                </div>
                                            </div>
                                            {{--/default/initial for add--}}

                                            @foreach($allmealimagesbymealid as $key => $row)
                                            {{--{{ dd($row) }}--}}
                                                <div data-repeater-item class="inner mb-3 row">
                                                    <div class="form-group col-lg-1" style="text-align: center">
                                                        {{--<input data-repeater-delete type="button" class="btn btn-primary btn-block inner" value="Delete" />--}} {{--style="position: absolute; top: 40%; left: 0%;"--}}
                                                    ...
                                                    <input type="hidden" name="outer-group[0][inner-group][{{$key+1}}][image_id]" value="{{$row->id}}" readonly>
                                                    <div class="form-group col-lg-3">
                                                        {{--<input type="text" class="form-control" name="name_image" autocomplete="name_image" placeholder="Enter a image name...">--}}
                                                        <input type="text" class="form-control" name="outer-group[0][inner-group][{{$key+1}}][name_image]" autocomplete="name_image" placeholder="Enter a image name..." value="{{ $row->name }}">
                                                    </div>

                                                    <div class="form-group col-lg-3">
                                                        {{--<input type="text" class="form-control" name="name_description" autocomplete="name_description" placeholder="Enter image description...">--}}
                                                        <input type="text" class="form-control" name="outer-group[0][inner-group][{{$key+1}}][name_description]" autocomplete="name_description" placeholder="Enter image description..." value="{{ $row->description }}">
                                                    </div>

                                                    <div class="form-group col-lg-3">
                                                        <div class="custom-file">
                                                            {{--<input type="file" class="custom-file-input" id="customFile" name="images_path" required onchange="readUrlImage(this);">--}}
                                                            <input type="hidden" readonly name="outer-group[0][inner-group][{{$key+1}}][images_path_old]" value="{{ $row->path }}">
                                                            <input type="file" class="custom-file-input" id="customFile" name="outer-group[0][inner-group][{{$key+1}}][images_path]" onchange="readUrlImage(this);">
                                                            {{--<label class="custom-file-label" for="customFile" name="image_path_label">Choose Image</label>--}}
                                                            <label class="custom-file-label" for="customFile" name="outer-group[0][inner-group][{{$key+1}}][image_path_label]">Attach New Image</label>
                                                            {{--<div class="invalid-feedback">
                                                                Please provide image.
                                                            </div>--}}
                                                        </div>
                                                    ...
                                                    <div class="form-group col-lg-1" style="text-align: center">
                                                        {{--<img src="{{asset($row->path)}}" style="width: 65px; height: 50px;" --}}{{-- id="image_prev" name="image_prev" >--}}{{--style="position: absolute; top: 20%; left: 0%;"--}}
                                                        <img src="{{asset($row->path)}}" id="image_prev" name="outer-group[0][inner-group][{{$key+1}}][image_prev]" style="width: 65px; height: 50px;">
                                                        {{--<img src="" id="image_prev" name="image_prev">--}}
                                                    </div>
                                                </div>
                                            @endforeach
